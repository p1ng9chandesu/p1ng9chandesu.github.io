...
description: "aespa WEEK - MAKE IT LEMONADE에 다녀왔어요."
img: posts/20260701/thumbnail.jpg
tags: [aespa, aespa WEEK, MAKE IT LEMONADE]
author: p1ng9chandesu
toc: true
---

<center><img src="/assets/img/posts/20260701/aespa-week-make-it-lemonade.jpg"></center>
에스파 컴백했어요. 정규 2집이고, 앨범 이름은 "**LEMONADE**"에요. 앨범을 내니 팝업을 하네요.~~(SM 진자 표독한것.)~~ 이번 팝업은 여의도 IFC와 한강 일대 였습니다. 그래서 다녀왔어요. 다녀온건 5월 말 ~ 6월 초이지만, 블로그 리뉴얼하느라 바빠서 후기를 지금에서야 업로드 하네요.
...
팝업 입장하면 주는 멤버별 개인 포스터엔데, 이 날은 닝닝과 윈터를 많이 받았음. 사람들이 주변에서 교환을 많이 구하고 있었는데, 지젤이랑 교환 가능하냐고 질문 하면, 그냥 교환해줬음. 이렇게 선행을 적립했는데, 이정도면 나 앨범깔 때, 교환 없이 최애 드볼 할 수 있을거 같음. 과연 가능 할지는 모르겠음.

<center><img src='/assets/img/posts/20260701/highball-popup.jpg'></center>
가챠 좀 돌다가, 하이볼 팝업이 30일부터라고 들어서 팝업한다는 "CU 여의도 선착장 1호점"으로 따릉이 타고 갔어요. 여의도 한강공원 안에 CU 많고, 이름도 비슷해서 찾느라 진짜 열심히 탔어요. 자세한 구매기는 [다음편](/aespa-lemonade-highball) 에서 풀어보겠습니다. 여기에서 풀기엔 내용이 좀 있는지라. 8개 사면 보냉백 줬는데, 술도 안먹는 사람이 보냉백 받으려고 8개씩 산 덕에 지금 집에 하이볼 있음.. 아 이거 어떻게 처분하지?

### 6월 3일 / 6월 7일

<center><img src='/assets/img/posts/20260701/can-version-album-vending-machine.jpg'></center>
가챠에서 파는 미니 레몬키링이 품절되고 나서 처음 온 날였음. 팝업 오픈이 오전 11시 였는데, 3일에는 오픈 40분 전에, 7일에는 오픈 1시간 전에 왔엇어요. 오픈런 줄은 3일과 7일 둘다 길었어요. 가챠 기계 보니깐 미니 레몬키링 품절 소식 이후로는 하루에 90개씩만 들어오는 것 같았습니다. 캡슐 가챠 기기가 2개씩 있었는데, 기기당 45개 정도 들어왔었음. 사진은 3일날 가챠 오픈런 줄섰을때, 캔 버전 자판기가 보여서 찍어봤는데, 캔버전은 저때부터 닝닝과 지젤만 남은거 같았어요. 7일에 갔을때는 캔버전은 아예 품절이였습니다.

<center><img src='/assets/img/posts/20260701/pre-order-merch.jpg'></center>
전시된 MD중에 가격표 안붙은 MD가 있었는데 그게 제일 이쁜 MD 였습니다. 역시 사전예약으로 파는 MD였어요. 팝업때 MD들 본품이 이쁜게 없어서 고민을 많이 했는데, 인형은 이미 집에 많고, 리유저블 컵은 실용성은 많이 없겠지만(얼죽아) 디자인이 탐났습니다. 팝업 초반에는 온라인 판매 전용이라는 안내가 없었는데, 질문하는 사람이 많았는지 3일부터? 계산하는 곳 앞에 안내판이 붙어 있었어요. 작년 리치맨 때는 인형도 현장에서 살 수 있었는데, 올해는 왜 온라인 판매 전용인지 모르겠네요.

<center><img src='/assets/img/posts/20260701/autographed.jpg'></center>
사실 팝업 기간동안 반지를 살까 말까 고민을 많이 했는데, 마지막 날에 결국 샀습니다. 그리고 SMini가 들어왔다 해서 SMini 실물을 처음 봤어요. 제복 에스파 진짜 짱이에요. 그리고 멤버들이 남기고간 싸인과 낙서를 많이 찾아본 것 같아요. 팝업에서 사려고 했는데, SMini는 품절이라고 해서 광야 가서 사려고 했어요.
...
광야에 가면, 항상 보는 모래속에 묻힌 'Savage'와 'Girls' 입니다. 요즘 "**Savage P.O.S Ver.**" 갖고 싶은데, 구하기 힘들어서 고민중이긴 합니다만 레모네이드 뮤비 나올때 마다, 저 바닥에 레모네이드 로고가 계속 나왔어요. 물론 타가수분 뮤비 나올때는 그분 로고 나왔음.
...
Smini는 지젤 제외하고 샀음. 지젤은 분철 타는게 있으니깐, 굳이? 사야하나 싶었음. 개인적으로 SMini에만 제복착이 들어갔을까 싶어 아쉬웠는데, SM 일하는거 보면 어느정도 이해는 가요.
